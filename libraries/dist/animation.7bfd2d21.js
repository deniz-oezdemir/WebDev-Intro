...
const floatRegex = exports.floatRegex = /(-)?([\d]*\.?[\d])+/g;
const colorRegex = exports.colorRegex = /(#[0-9a-f]{6}|#[0-9a-f]{3}|#(?:[0-9a-f]{2}){2,4}|(rgb|hsl)a?\((-?[\d\.]+%?[,\s]+){2}(-?[\d\.]+%?)\s*[\,\/]?\s*[\d\.]*%?\))/gi;
const singleColorRegex = exports.singleColorRegex = /^(#[0-9a-f]{3}|#(?:[0-9a-f]{2}){2,4}|(rgb|hsl)a?\((-?[\d\.]+%?[,\s]+){2}(-?[\d\.]+%?)\s*[\,\/]?\s*[\d\.]*%?\))$/i;
function isString(v) {
...
const alpha = exports.alpha = Object.assign(Object.assign({}, number), {
  transform: (0, _utils.clamp)(0, 1)
});
const scale = exports.scale = Object.assign(Object.assign({}, number), {
  default: 1
});
...
const degrees = exports.degrees = createUnitType('deg');
const percent = exports.percent = createUnitType('%');
const px = exports.px = createUnitType('px');
const vh = exports.vh = createUnitType('vh');
const vw = exports.vw = createUnitType('vw');
const progressPercentage = exports.progressPercentage = Object.assign(Object.assign({}, percent), {
...
const rgbUnit = exports.rgbUnit = Object.assign(Object.assign({}, _index.number), {
...
const filter = exports.filter = Object.assign(Object.assign({}, _index.complex), {
  getAnimatableNone: v => {
...
const zeroPoint = exports.zeroPoint = {
  x: 0,
  y: 0,
  z: 0
};
...
const easeIn = exports.easeIn = (0, _utils.createExpoIn)(2);
const easeOut = exports.easeOut = (0, _utils.reverseEasing)(easeIn);
const easeInOut = exports.easeInOut = (0, _utils.mirrorEasing)(easeIn);
const circIn = p => 1 - Math.sin(Math.acos(p));
exports.circIn = circIn;
const circOut = exports.circOut = (0, _utils.reverseEasing)(circIn);
const circInOut = exports.circInOut = (0, _utils.mirrorEasing)(circOut);
const backIn = exports.backIn = (0, _utils.createBackIn)(DEFAULT_OVERSHOOT_STRENGTH);
const backOut = exports.backOut = (0, _utils.reverseEasing)(backIn);
const backInOut = exports.backInOut = (0, _utils.mirrorEasing)(backIn);
const anticipate = exports.anticipate = (0, _utils.createAnticipate)(DEFAULT_OVERSHOOT_STRENGTH);
...
const bounceIn = exports.bounceIn = (0, _utils.reverseEasing)(bounceOut);
...
const defaultTimestep = exports.defaultTimestep = 1 / 60 * 1000;
const getCurrentTime = typeof performance !== "undefined" ? () => performance.now() : () => Date.now();
const onNextFrame = exports.onNextFrame = typeof window !== "undefined" ? callback => window.requestAnimationFrame(callback) : callback => setTimeout(() => callback(getCurrentTime()), defaultTimestep);
...
},{}],"../../.nvm/versions/node/v22.9.0/lib/node_modules/parcel-bundler/node_modules/process/browser.js":[function(require,module,exports) {
...
const cancelSync = exports.cancelSync = stepsOrder.reduce((acc, key) => {
  acc[key] = steps[key].cancel;
  return acc;
}, {});
const flushSync = exports.flushSync = stepsOrder.reduce((acc, key) => {
...
const attract = exports.attract = createAttractor();
const attractExpo = exports.attractExpo = createAttractor(Math.sqrt);
...
popmotion.animate({
  ...
  onUpdate: function onUpdate(update) {
    // console.log(update);
    ball.style.right = update;
    ball.style.top = update;
  }
});
},{"popmotion":"node_modules/popmotion/dist/es/index.mjs"}],"../../.nvm/versions/node/v22.9.0/lib/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
},{}]},{},["../../.nvm/versions/node/v22.9.0/lib/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","animation.js"], null)
